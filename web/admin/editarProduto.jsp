                ...
                <main>
                    ...
                    <%
                        ...
                        try {
                            ...
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    <small>Formulario de atualizacao de produto</small>
                                    <form action="config/editarProduto.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="<%=rs.getString("descricao")%>" name="desc" placeholder="Descri??o do produto"/> 
                                        </div>
                                        <div class="mb-3">
